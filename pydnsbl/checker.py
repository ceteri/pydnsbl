...
Checker for domains
    ...
    def __init__ (
        self,
        providers = BASE_DOMAIN_PROVIDERS,
        timeout: int = 5,
        tries: int = 2,
        concurrency: int = 200,
        loop = None,
...
Prepare a DNS query.
        """
        request = request.lower() # support for capitalized letters in domain name
        domain_idna: str = idna.encode(request).decode()
